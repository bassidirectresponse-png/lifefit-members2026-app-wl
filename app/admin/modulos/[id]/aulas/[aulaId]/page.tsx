  ...
  const load = useCallback(async () => {
    ...
    if (aRes.data) {
      ...
      setForm({
        ...
        tipo: a.tipo as TipoAula,
        conteudo_url: a.conteudo_url || "",
              ...
              return (
                <button
                  ...
                  className={cn(
                    ...
                    sel ? "border-pink-primary bg-pink-primary/10 text-pink-primary" : "border-border bg-bg-tertiary text-text-secondary hover:border-pink-border"
                  )}
                >
